		...
		<tr>
			<td valign="top">
				...
				<ul>
					...
					<li><a href="MyFormula.svc/" target="_blank">service
							document</a></li>
				...
				<ul>
					...
					<li><a href="MyFormula.svc/Manufacturers/?$expand=Cars"
						target="_blank">Manufacturers/?$expand=Cars</a></li>
					<li><a href="MyFormula.svc/Cars" target="_blank">Cars</a></li>
					<li><a href="MyFormula.svc/Cars/?$expand=Driver"
						target="_blank">Cars/?$expand=Driver</a></li>
					<li><a href="MyFormula.svc/Drivers" target="_blank">Drivers</a></li>
					<li><a href="MyFormula.svc/Drivers/?$expand=Car"
						target="_blank">Drivers/?$expand=Car</a></li>
					<li><a href="MyFormula.svc/Drivers/?$orderby=Lastname"
						target="_blank">Drivers/?$orderby=Lastname</a></li>
					<li><a
						href="MyFormula.svc/Drivers/?$filter=year(Birthday)%20gt%201981"
						target="_blank">Drivers/?$filter=year(Birthday) gt 1981</a></li>
				</ul>
				<h3>Entities</h3>
				<ul>
					<li><a href="MyFormula.svc/Manufacturers('1')" target="_blank">Manufacturers('1')</a></li>
					<li><a href="MyFormula.svc/Manufacturers('1')/Cars"
						target="_blank">Manufacturers('1')/Cars</a></li>
					...
					<li><a href="MyFormula.svc/Cars('1')/?$expand=Manufacturer"
						target="_blank">Cars('1')/?$expand=Manufacturer</a></li>
				...
				<div class="code">
					<%
						if (request.getParameter("genSampleData") != null) { //genSampleData is the name of your button, not id of that button.
							...
							org.apache.olingo.sample.annotation.util.AnnotationSampleDataGenerator
									.generateData(requestUrl + "MyFormula.svc");
							response.sendRedirect(requestUrl);
						}
					%>
					<form method="POST">
						<div>
							For generation of sample data this button can be used. <br /> But
							be aware that multiple clicking results in multiple data
							generation.
						</div>
						<input type="submit" id="genSampleData" name="genSampleData"
